...
label h1:
    ...
    if h1_v == 0:
        ...
        "*Но в соседнем окне виднелся размытый силуэт*"
        "*Внимание отвлекла резко отпершаяся дверь*"
        "*К вам стремительно стал приближаться мужчина, у которого ярко светились глаза, будто от каких-то безумных идей*"
        ...
        "*Заметив карту в ваших руках, мужчина остановил на ней свой взгляд, а на его губах появилась улыбка*"
...
label h1_q:
    menu:
        ...
        "2. Чем вы занимаетесь?":
            hide screen map_but
            m_30 "Раньше служил, теперь вот книжки пишу, наверняка вам уже попадались мои работки"
