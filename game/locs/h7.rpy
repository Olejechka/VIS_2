...
label h7:
    ...
    if h7_v == 0:
        hide screen map_but
        "*Проходя ближе к следующему домику, всё отчётливее слышался детский смех. *"
        vovan "Привет!"
        "*После этих слов до нас донёсся звук закрывания двери.*"
