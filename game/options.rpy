...
define config.version = "0.743"


## Текст, помещённый в экран "Об игре". Поместите текст между тройными скобками.
## Для отделения абзацев оставляйте между ними пустую строку.

define gui.about = _p(""" Вставить нормальное описание позже
""")
...
define config.save_directory = "Viz-1765040951"
...
define config.window_icon = "gui/k.png"
